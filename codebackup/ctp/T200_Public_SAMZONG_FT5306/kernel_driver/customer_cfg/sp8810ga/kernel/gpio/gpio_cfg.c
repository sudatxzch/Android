...
zhucaihua 2012-3-27 modify sprd_3rdparty_gpio_tp_rst default pull high from low to avoid Wangbo's TP cannot work issue
...
int sprd_3rdparty_gpio_lcd_led; //hushilun add
int sprd_3rdparty_gpio_flash_led; //hushilun add
int sprd_3rdparty_gpio_af_pwr; //hushilun add
...
//<zhucaihua 2012-3-27 modify sprd_3rdparty_gpio_tp_rst default pull high from low to avoid Wangbo's TP cannot work issue>
	{&sprd_3rdparty_gpio_tp_rst,		59	|GPIO_DEFAUT_HIGH	|GPIO_DIRECTION_OUTPUT	|GPIO_LOGIC_TRUE},
	...
	{&sprd_3rdparty_gpio_flash_led,		135	|GPIO_DEFAUT_LOW	|GPIO_DIRECTION_OUTPUT	|GPIO_LOGIC_TRUE}, //hushilun add
	{&sprd_3rdparty_gpio_lcd_led,		143  |GPIO_DEFAUT_LOW	|GPIO_DIRECTION_OUTPUT	|GPIO_LOGIC_TRUE},//hushilun add
	{&sprd_3rdparty_gpio_af_pwr,		144  |GPIO_DEFAUT_LOW	|GPIO_DIRECTION_OUTPUT	|GPIO_LOGIC_TRUE},//hushilun add
