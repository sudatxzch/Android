...
static struct i2c_board_info __initdata i2c_boardinfo[] = {
	{I2C_BOARD_INFO("apds990x", 0x39),},//zhucaihua modify for APDS990X
...
static struct i2c_board_info __initdata i2c_boardinfo2[] = {
	{I2C_BOARD_INFO("ctp_it7260", 0x46),},//zhucaihua add for ADD1/ADD0: 00=0x46, 01=0x35, 10=0x6E, 11=0x17
	{I2C_BOARD_INFO("ft5306_ts", 0x38),},//zhucaihua add for FT5206
